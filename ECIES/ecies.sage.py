...
def ecies_encrypt(K, m):
	r = ZZ.random_element(_sage_const_1 ,n)
	R = r * G
	#r*Kpub
...
m1 = b"ecies is great"
print(f'Message1 = {m1}')
(Ki1, Ci1, tag) = asa_enc(ecies_K, psk, _sage_const_0 )
print(f'Ki1 = {Ki1}\nCi1 = {Ci1}\ntag = {tag}')
